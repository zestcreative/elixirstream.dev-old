defmodule ElixirStream.Factory do
  use ExMachina.Ecto, repo: ElixirStream.Repo

  def user_factory do
    %ElixirStream.Accounts.User{
      source_id: sequence(:user_source, &"#{&1}"),
      source: "github",
      name: "User Name",
  ...
  def github_auth_factory do
    %Ueberauth.Auth{
      ...
      info: %Ueberauth.Auth.Info{
        birthday: nil,
        description: nil,
        email: "643968+dbernheisel@users.noreply.github.com",
        first_name: nil,
        image: "https://avatars.githubusercontent.com/u/643968=4",
        last_name: nil,
        location: "Foo, NC",
        name: "David Bernheisel",
